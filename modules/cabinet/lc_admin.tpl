            ...
            <form name="frmEdit" method="post" action="" style="margin: 0px; padding: 0px;" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-6">
                        ...
                        <input type="text" class="form-control" name="login" id="login" placeholder="Придумайте логин"  required value="{LOGIN}" disabled>
                    </div>
                    <div class="form-group col-6">
                        <label for="login" class="form-label">Номер телефон</label>
                    ...
                    <div class="form-group col-6">
                        <label for="login" class="form-label">Адрес</label>
					...
					<!--<div class="form-group col-6">
                        <label for="nauch_direction" class="form-label">Направление научной деятельности</label>
                        <input type="text" class="form-control" name="nauch_direction" id="nauch_direction" placeholder="Направление научной деятельности" required value="{NAUCH_VALUE}">
                    </div>
					<div class="form-group col-6">
                        <label for="dolzhnost" class="form-label">Должность</label>
                        <input type="text" class="form-control" name="dolzhnost" id="dolzhnost" placeholder="Должность" required value="{DOLZHNOST}">
                    </div>
                    <div class="form-group col-6">
