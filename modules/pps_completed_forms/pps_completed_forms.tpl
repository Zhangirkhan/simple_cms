    ...
    <div class="col-md-12 col-lg-12">
        <div class="card" id="users">
            ...
            <div class="card-header">
                <div class="card-title">Заполненные формы</div>
                ...
                <div class="table-responsive-sm" {DISPLAY}>
                    <table id="example" class="table table-striped table-bordered" {DISPLAY}>
                        <thead>
                            <tr>
                                <th class="wd-15p">#</th>
                                <th class="wd-15p">Категория форм</th>
                                <th class="wd-15p">Название форм</th>
                                <th class="wd-10p">Последняя дата добавления</th>
                                <th class="wd-10p">Количество добавленных данных</th>
