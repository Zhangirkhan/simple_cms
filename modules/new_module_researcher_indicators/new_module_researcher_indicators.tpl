                ...
                <form action="" method="post" name="categoryFilterForm">
                    <div class="row">
                            ...
                            <div class="form-group col-xl-2 col-lg-2 col-md-2">
                                <label for="recipient-name" class="form-control-label">Категория индикатора</label>
                            ...
                            <div class="form-group col-xl-2 col-lg-2 col-md-2">
                                <label for="recipient-name" class="form-control-label">Название индикатора</label>
                                <select name="categoryFilter" class="form-control" onchange="categoryFilterForm.submit();">
                                    <option value="0">{STR_SHOW_ALL}</option>
                                    {CATEGORY_FILTER_LIST}
                                </select>
                            ...
                            <div class="form-group col-xl-2 col-lg-2 col-md-2">
                                <label for="recipient-name" class="form-control-label">Пользователь</label>
                                <select name="categoryFilter" class="form-control" onchange="categoryFilterForm.submit();">
                                    <option value="0">{STR_SHOW_ALL}</option>
                                    {CATEGORY_FILTER_LIST}
                                </select>
                            ...
                            <div class="form-group col-xl-2 col-lg-2 col-md-2">
                                <label for="recipient-name" class="form-control-label">Статус</label>
                                <select name="categoryFilter" class="form-control" onchange="categoryFilterForm.submit();">
                                    <option value="0">{STR_SHOW_ALL}</option>
                                    {CATEGORY_FILTER_LIST}
                                </select>
            ...
            <div class="table-responsive" {NODATA_DISPLAY} >
                    ...
                    <table id="indicators" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                <th class="wd-15p">#</th>
                                <th class="wd-15p">Категория индикатора</th>
                                <th class="wd-15p">Название индикатора</th>
                                <th class="wd-15p">Пользователь</th>
                                <th class="wd-15p">Данные</th>
                                <th class="wd-15p">Файл</th>
                                <th class="wd-15p">Балл</th>
                                <th class="wd-15p">Статус</th>
                                <th class="wd-15p">Причина отклонения</th>
