<div class="row">
    <div class="col-md-12 col-lg-12">
        <div class="card" id="categories">
            ...
            <div class="card-body">
            {NODATA}
            <div style="width:100%; padding:10px; border:1px solid #074776">
                {TREE_VIEW}
            </div>
            ...
            <!--<div class="table-responsive" {NODATA_DISPLAY}>
                    <table id="univers" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                <th class="wd-15p">#</th>
                                <th class="wd-15p">Ирархия поразделения</th>
                                <th class="wd-25p">Статус</th>
                                <th class="wd-25p">Тип подразделения</th>
                                <th class="wd-25p">Университет</th>
