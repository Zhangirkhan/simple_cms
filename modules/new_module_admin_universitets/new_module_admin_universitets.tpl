            ...
            <div class="card-header">
                ...
                <div class="card-options">
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <a class="btn btn-primary" data-toggle="modal" data-target="#add" href="#">{STR_ADD_UNIVER}</a>
                        <a class="btn btn-success" href="/pps_nirs_pdf.php" target="blank">{STR_DOWNLOAD_UNIVER_LIST}</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
