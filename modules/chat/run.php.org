...
// Список пользователей и сообщении ///////////////////////////////////////////
		...
		if (db_num_rows($chatuserslist) > 0) {
			...
			$tpl->assign("NO_CHATS", 'У Вас еще нет активных чатов. Для создания чата с другим пользователем нажмите кнопку <a class="btn-sm" data-toggle="modal" data-target="#addchat" href="#"><i class="fa fa-plus"></i> Добавить Чат</a>');
		}
