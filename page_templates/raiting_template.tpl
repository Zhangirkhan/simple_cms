...
<head>
    ...
    <!-- Dashboard Core -->
    <script src="../assets/js/vendors/jquery-3.2.1.min.js"></script> <!--  <script src="../assets/js/vendors/jquery-3.2.1.min.js"></script> -->
	<script src="//code.jivosite.com/widget/d1JcryjiLf" async></script>
</head>
                ...
                <div class="container-fluid">
                    <div class="d-flex">
                        <a class="header-brand text-white" href="#">
                            <img src="../assets/images/brand/logo_kazgasa.png" style="height: 50px; width: 50px" class="header-brand-img" alt="Jobslist logo">
                            КазГАСА
                        </a>
                            ...
                            <div class="dropdown ">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow ">
                                    <a class="dropdown-item" href="login.html">
                                        <i class="dropdown-icon icon icon-power"></i> Всё в разработке
                                    </a>
                                    <a class="dropdown-item" href="profile.html">
                                        <i class="dropdown-icon icon icon-user"></i> Мой профиль
                                    </a>
                                    <a class="dropdown-item" href="emailservices.html">
                                        <i class="dropdown-icon icon icon-speech"></i> Входящие
                                    </a>
                                    <a class="dropdown-item" href="editprofile.html">
                                        <i class="dropdown-icon  icon icon-settings"></i> Настройки
                                    </a>
                                    <a class="dropdown-item" href="login.html">
                                        <i class="dropdown-icon icon icon-power"></i> Выход
                                    </a>
                                </div>
                            </div>
                        </div>
           ...
           <!-- <aside class="app-sidebar doc-sidebar">
                <div class="app-sidebar__user clearfix">
                    <div class="dropdown user-pro-body">
                        ...
                        <div class="user-info">
                            <h2>{TPL_NAME_VALUE} ({TPL_USER_NAME_VALUE})</h2>
                            <span>{TPL_TYPE_VALUE}</span>
                        </div>
                    </div>
                </div>
                <ul class="side-menu">
