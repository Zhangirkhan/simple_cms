...
<head>
    <base href="https://ehome.sidelka-galina.kz/">
	<meta charset="UTF-8">
...
<body>
							...
							<div class="clearfix">
								<ul class="contact border-left">
									...
									<li class="dropdown d-none d-xl-inline-block">
										<a href="#" class="" data-toggle="dropdown"><span> Language <i
									...
									<li class="dropdown d-none d-xl-inline-block">
										<a href="#" class="" data-toggle="dropdown"><span>Currency <i
													class="fa fa-caret-down"></i></span></a>
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
											<a href="#" class="dropdown-item">
												USD
					...
					<div class="col-xl-5 col-lg-5 col-sm-8 col-5">
						<div class="top-bar-right">
							<ul class="custom">
								...
								<li class="dropdown">
									<a href="#" class="" data-toggle="dropdown"><i class="fa fa-home mr-1"></i><span> My
											Dashboard</span></a>
									<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
								...
								<li>
									<a href="login.html" class=""><i class="fa fa-black-tie mr-1"></i> <span>For
											Employer</span></a>
								</li>
							</ul>
						</div>
				...
				<nav class="horizontalMenu clearfix d-md-flex">
					<ul class="horizontalMenu-list">
									...
									<div class="megamenu-content">
										<div class="row">
											...
											<ul class="col link-list">
												...
												<li><a href="widgets-verticalscroll.html">Vertical Scroll Widgets</a>
												</li>
						...
						<li class="d-lg-none pt-5 pb-2 mt-lg-0">
							<span><a class="btn btn-secondary ad-post mt-1" href="ad-posts.html"><i
										class="fa fa-briefcase"></i> Submit a Job</a></span>
						</li>
						<li class="d-lg-none mt-0 pb-5 mt-lg-0">
							<span><a class="btn btn-info ad-post mt-1" href="create-resume.html"><i
										class="fa fa-edit"></i> Create Resume</a></span>
						</li>
					</ul>
					<ul class="mb-0 pr-2">
			...
			<div class="header-text mb-0">
				<div class="container">
					<div class="text-center text-white">
						<h1 class="">Личный кабинет ОСИ</h1>
						<ol class="breadcrumb text-center">
							<li class="breadcrumb-item"><a href="#">Главная</a></li>
							<li class="breadcrumb-item active text-white" aria-current="page">Личный кабинет ОСИ</li>
						</ol>
					</div>
				</div>
			</div>
				...
				<div class="col-xl-3 col-lg-12 col-md-12">
					<div class="card">
						<div class="card-header">
							<h3 class="card-title">Личный кабинет ОСИ</h3>
						</div>
						<div class="card-body text-center item-user border-bottom">
							<div class="profile-pic">
								...
								<a href="userprofile.html" class="text-dark">
									<h4 class="mt-3 mb-0 font-weight-semibold">Рустем Едыгенов</h4>
								</a>
							</div>
						</div>
						<div class="item1-links  mb-0">
							<a href="mydash.html" class="active d-flex border-bottom">
								<span class="icon1 mr-2"><i class="typcn typcn-edit fs-20"></i></span> Редактировать
								профиль
							</a>
							<a href="myjobs.html" class=" d-flex border-bottom">
								<span class="icon1 mr-2"><i class="typcn typcn-briefcase fs-20"></i></span> Мои ОСИ
							</a>
							<a href="myfavorite.html" class="d-flex border-bottom">
								<span class="icon1 mr-2"><i class="typcn typcn-heart-outline fs-20"></i></span> Мои
								квартиры
							</a>
							<a href="manged.html" class="d-flex  border-bottom">
								<span class="icon1 mr-2"><i class="typcn typcn-folder fs-20"></i></span> Мои заявки
							</a>
							<a href="payments.html" class=" d-flex  border-bottom">
								<span class="icon1 mr-2"><i class="typcn typcn-credit-card fs-20"></i></span>
								Голосования
							</a>
							<a href="orders.html" class="d-flex  border-bottom">
								<span class="icon1 mr-2"><i class="typcn typcn-shopping-cart fs-20"></i></span>
								Уведомления
							</a>
							<a href="tips.html" class="d-flex border-bottom">
								<span class="icon1 mr-2"><i class="typcn typcn-flag-outline fs-20"></i></span> Смета
								расходов
							</a>
							<a href="login.html" class="d-flex">
								<span class="icon1 mr-2"><i class="typcn typcn-power-outline fs-20"></i></span> Выход
							</a>
						</div>
					</div>
	...
	<section>
		...
		<!-- Message Modal -->
		<div class="modal fade" id="add-document" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="example-Modal3">Добавить документ</h5>
					...
					<div class="modal-body">
						<form>
							<div class="form-group">
								<label for="recipient-name" class="form-control-label">Название документа:</label>
								<input type="nameDocument" class="form-control" id="recipient-name">
							</div>

							<div class="form-group">
								<div class="form-label">Выберите документ</div>
								<div class="custom-file">
									<input type="file" class="custom-file-input" name="example-file-input-custom"
										value="Выберите файл">
									<label class="custom-file-label">Выберите документ</label>
								</div>
							</div>
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary">Добавить документ</button>
					</div>
				</div>
			</div>
		</div>
		...
		<!-- Message Modal -->
		<div class="modal fade" id="edit-document" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="example-Modal3">Редактировать документ</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Закрыть">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
		...
		<div class="modal fade" id="add-news" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="example-Modal3">Добавить новость</h5>
					...
					<div class="modal-body">
						<form>
							<div class="form-group">
								<label for="recipient-name" class="form-control-label">Заголовок новости:</label>
								<input type="text" class="form-control" id="recipient-name">
							</div>
							<div class="form-group">
								<label for="message-text" class="form-control-label">Описание новости:</label>
								<textarea class="form-control" id="message-text"></textarea>
							</div>
							<div class="form-group">
								<div class="form-label">Выберите фото</div>
								<div class="custom-file">
									<input type="file" class="custom-file-input" name="example-file-input-custom"
										value="Выберите файл">
		...
		<!-- Message Modal -->
		<div class="modal fade" id="edit-news" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="example-Modal3">Редактировать новость</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
